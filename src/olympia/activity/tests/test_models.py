...
class TestActivityLog(TestCase):
    ...
    def test_basic(self):
        ...
        for x in ('Delicious Bookmarks', 'was created.'):
            assert x in text_type(entries[0])
    ...
    def test_addon_log(self):
        ...
        entries = ActivityLog.objects.for_addons(addon)
        assert len(entries) == 1
        assert addon.get_url_path() in text_type(entries[0])
    ...
    def test_addon_log_unlisted_addon(self):
        ...
        entries = ActivityLog.objects.for_addons(addon)
        assert len(entries) == 1
        assert url_path not in text_type(entries[0])
    ...
    def test_output(self):
        ...
        entry = ActivityLog.objects.get()
        assert text_type(entry) == 'hi there'
    ...
    def test_version_log(self):
        ...
        assert len(entries) == 1
        assert version.get_url_path() in text_type(entries[0])
