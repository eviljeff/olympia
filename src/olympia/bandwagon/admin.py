...
class CollectionAdmin(admin.ModelAdmin):
    ...
    def has_module_permission(self, request):
        return acl.action_allowed(request, amo.permissions.ADMIN_CURATION) or super().has_module_permission(request)
    ...
    def has_add_permission(self, request):
        return acl.action_allowed(request, amo.permissions.ADMIN_CURATION) or super().has_add_permission(request)
